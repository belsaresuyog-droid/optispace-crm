...
function negotiatedPayload(payload:Record<string,any>,negotiation:any){
  ...
  return {...payload,details:{...(payload.details||{}),basic:Number(negotiation.negotiatedProposalValue)||0,commercialSource:"Negotiated proposal",proposalId:Number(negotiation.proposalId),negotiationUpdatedAt:negotiation.negotiationUpdatedAt}};
}
