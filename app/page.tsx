  ...
  return <div className="invoice-workspace">
    ...
    <main className="invoice-preview-wrap">
      ...
      <article className="invoice-document">
        ...
        <footer className="invoice-footer"><div><small>NEFT / RTGS PAYMENT</small><b>HDFC Bank · Account name: Solutions</b><span>A/c 50200002466308 · IFSC HDFC0000825</span><span>Hingne Khurd, Pune 411051 · PAN AADPU0566C</span></div><div><span>For Solutions</span><b>Authorised Signatory</b></div></footer>
      </article>
    </main>
  </div>;
}
